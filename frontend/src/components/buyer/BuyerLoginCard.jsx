...
function BuyerLoginCard({ form, loading, status, error, onChange, onSubmit }) {
  const activeMode = AUTH_MODES.buyer;
      ...
      <form className="auth-form" onSubmit={onSubmit}>
        <label>
          ...
          <input
            ...
            placeholder="buyer@agrilink.test"
            autoComplete="email"
            required
          />
        </label>
        ...
        <button className="primary-button" type="submit" disabled={loading}>
          {loading ? "Signing in..." : "Open buyer dashboard"}
        </button>
      </form>
