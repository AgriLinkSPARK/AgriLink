...
function CreateLogistics({ isOpen, onClose, onSubmit, orders = [], prefillOrder = null }) {
  ...
  const generateMapEmbedUrl = () => {
    if (!formData.deliveryLocation) return null;
    const encodedLocation = encodeURIComponent(formData.deliveryLocation);
    return `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126743.281 Divine!2d${formData.longitude || 79.8612}!3d${formData.latitude || 6.9271}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwNTUnMzcuNyJOIDc5wrA1MSc0MC4zIkU!5e0!3m2!1sen!2slk!4v1&q=${encodedLocation}`;
  };
